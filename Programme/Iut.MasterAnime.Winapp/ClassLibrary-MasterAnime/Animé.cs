...
{
    /// <summary>
    /// Représente le type Animé
    /// </summary>
    public class Animé : Oeuvre, IDataErrorInfo
    {
        /// <summary>
        ...
        /// <summary>
        /// Le nom du studio d'animation de l'oeuvre ainsi que son getter et setter
        /// Possède 16 caractères maximum
        /// </summary>
        [MaxLength(16, ErrorMessage = "Maximum 16 caractères")]
        ...
        /// <summary>
        /// Contructeur de la classe Animé
        /// </summary>
        ...
        /// <param name="studio">Le nom du studio d'animation de l'oeuvre. Par défaut : "Inconnu"</param>
        ...
        public Animé(String nom, String image, DateTime sortie, String auteur, String studio,
        ...
        /// <summary>
        /// Contructeur de la classe Animé. Celui-ci permet d'instancier un guid à partir d'un connu, pour la persistance
        /// </summary>
        /// <param name="nom">Le nom de l'oeuvre</param>
        /// <param name="image">Le nom et le type de l'image de l'oeuvre. Par défaut : "PlacerImage.png"</param>
        /// <param name="sortie">La date de sortie de l'oeuvre, en DateTime. Par défaut celle d'aujoud'hui</param>
        ...
        /// <summary>
        /// Permet de modifier les informations de l'Animé.
        ...
        public void ModifierOeuvre(String newNom, String newImage, DateTime newSortie, String newAuteur, String newStudio,
        ...
        /// <summary>
        /// Permet de modifier les informations de Animé à partir des informations d'un différent Animé
        /// </summary>
        /// <param name="animé">L'oeuvre à partir de laquelle on récupère les informations à modifier</param>
        public void ModifierOeuvre(Animé animé)
        {
            ModifierOeuvre(animé.Nom, animé.Image, animé.Sortie, animé.Auteur, animé.Studio, animé.InformationsComplémentaires,
                animé.Synopsis, animé.Commentaire);
        }

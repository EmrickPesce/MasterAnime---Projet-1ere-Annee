...
{
    /// <summary>
    /// Représente le type Série
    /// </summary>
    public class Série : Cinématographique
    {
        /// <summary>
        /// Contructeur de la classe Série
        /// </summary>
        ...
        public Série(String nom, String image, DateTime sortie, String réalisateur, String studio,
        ...
        /// <summary>
        /// Contructeur de la classe Série. Celui-ci permet d'instancier un guid à partir d'un connu, pour la persistance
        /// </summary>
        /// <param name="nom">Le nom de l'oeuvre</param>
        /// <param name="image">Le nom et le type de l'image de l'oeuvre. Par défaut : "PlacerImage.png"</param>
        /// <param name="sortie">La date de sortie de l'oeuvre, en DateTime. Par défaut celle d'aujoud'hui</param>

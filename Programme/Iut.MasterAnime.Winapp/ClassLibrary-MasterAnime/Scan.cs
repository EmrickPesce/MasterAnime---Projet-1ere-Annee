...
{
    /// <summary>
    /// Représente le type Scan
    /// </summary>
    public class Scan : Littéraire
    {
        /// <summary>
        /// Contructeur de la classe Scan
        /// </summary>
        ...
        public Scan(String nom, String image, DateTime sortie, String auteur, String éditeur,
        ...
        /// <summary>
        /// Contructeur de la classe Scan. Celui-ci permet d'instancier un guid à partir d'un connu, pour la persistance
        /// </summary>
        /// <param name="nom">Le nom de l'oeuvre</param>
        /// <param name="image">Le nom et le type de l'image de l'oeuvre. Par défaut : "PlacerImage.png"</param>
        /// <param name="sortie">La date de sortie de l'oeuvre, en DateTime. Par défaut celle d'aujoud'hui</param>

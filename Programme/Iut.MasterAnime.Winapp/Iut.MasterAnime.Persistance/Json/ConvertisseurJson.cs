...
{
    /// <summary>
    /// Permet de convertir des données (string) en Json et inversement
    /// </summary>
    public static class ConvertisseurJson
    {
        /// <summary>
        ...
        private static Oeuvre JTokenVersOeuvre(JToken jTokenOeuvre)
        {
            Oeuvre oeuvreRetour;
        ...
        private static ObservableCollection<Oeuvre> JObjectVersObservableCollectionOeuvre(JToken jObject)
        {
            ...
            jObject.Select(o => JTokenVersOeuvre(o["oeuvre"])).ToList().ForEach(oeuvre => collectionRetour.Add(oeuvre));
